...
>>>>>>> d69511793b5691513e4104e5bd500c330ab7db75
  ...
  for (let item in keys) {
    ...
    let central = document.createElement('span');
    el.id = item;
...
function handleClick(id) {
  ...
  switch (id) {
    ...
    case 'ArrowUp':
      {
        let start = arrowHelper().start;
        let pos = arrowHelper().pos;
        let end = arrowHelper().end;
        let line = arrowHelper().line;
        let arr = arrowHelper().arr;
        let index = arrowHelper().index;
        let calcPos = 0;
    ...
    case 'ArrowLeft':
      {
        ...
        text.selectionEnd = text.selectionEnd - 1;
      }
      break;
    case 'ArrowDown':
      {
